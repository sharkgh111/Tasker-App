         ...
         <div className="rounded-md text-main_lightly flex flex-col justify-evenly flex-1 h-full w-full overflow-hidden">
            <div className="flex items-center justify-center">
               <div className="h-[70%] p-8 gap-10 flex flex-col justify-center">
                  <h1 className="text-4xl font-light mb-6 font-montserrat-light">Керуй своїми справами без зайвого хаосу</h1>
                  <p className="pb-5 text-lg leading-relaxed text-justify font-montserrat-medium border-b-4 border-main_lightly/20">
                     Tasker — це твій мінімалістичний та швидкий інструмент для щоденного планування. Більше не потрібно тримати сотні завдань у голові чи
                     записувати їх на клаптиках паперу. Наш задачник створений для тих, хто цінує простоту: жодних перевантажених інтерфейсів, лише ти і твої
                     цілі. Фокусуйся на важливому, плануй свій день за лічені секунди та відчувай задоволення від кожного виконаного пункту.
                  </p>
               </div>
