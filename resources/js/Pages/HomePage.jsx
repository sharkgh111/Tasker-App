                    ...
                    <div className="flex items-center justify-center">
                         <div className="h-[70%] p-8 gap-10 flex flex-col justify-center">
                              ...
                              <p className="pb-5 text-lg leading-relaxed text-justify font-montserrat-medium border-b-4 border-main_lightly/20">
                                   Tasker — це твій мінімалістичний та швидкий інструмент для щоденного планування. Більше не потрібно тримати сотні завдань у голові чи записувати їх на клаптиках
                                   паперу. Наш задачник створений для тих, хто цінує простоту: жодних перевантажених інтерфейсів, лише ти і твої цілі. Фокусуйся на важливому, плануй свій день за
