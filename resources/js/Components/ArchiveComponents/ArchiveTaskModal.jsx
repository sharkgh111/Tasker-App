...
export default function Modal({ setIsInfoOpen, title, description, deadline, priority, categories, isInfoOpen }) {
   return (
      <Transition show={isInfoOpen} as={React.Fragment} afterLeave={() => setIsInfoOpen(false)}>
         <Dialog as="div" className="relative z-50" onClose={() => setIsInfoOpen(false)}>
            ...
            <div className="fixed inset-0 overflow-y-auto flex items-center justify-center p-4">
               ...
               >
                  <DialogPanel className="w-full max-w-xl h-auto transform rounded-2xl p-4 bg-main_green_primary border-[3px] border-main_lightly text-left align-middle shadow-2xl transition-all">
                     <DialogTitle as="div" className="flex items-center justify-center gap-4">
                        <BsInfoSquare className="w-8 h-8 text-main_lightly" />
                        <h2 className="text-3xl font-montserrat-medium text-main_lightly">Деталі завдання</h2>
                     </DialogTitle>
