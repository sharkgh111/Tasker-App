...
export default function OtherOptions({setData, data, errors}) {
    ...
    const handleCategoryClick = (categoryName) => {
        ...
        if (currentCategories.includes(categoryName)) {
            setData('categories', currentCategories.filter((item) => item !== categoryName));
        } else {
                        ...
                        return (
                            <button
                                ...
                                className={`
                                    ...
                                    ${isSelected 
                                        ? 'text-succes_light font-montserrat-bold scale-105' 
                                        : 'text-main_lightly hover:text-main_lightly/80'
                                    }
                                `}
                            >
