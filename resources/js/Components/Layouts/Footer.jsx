      ...
      <>
         <footer className="w-full flex-shrink-0 overflow-hidden flex justify-center h-[80px] shadow-xl bg-main_green_dark/10 backdrop-blur-xl rounded-md px-5 mt-4">
            <div className="flex flex-1 justify-between items-center relative">
               ...
               <p className="text-main_lightly absolute h-full font-montserrat-medium flex items-end font-medium top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  © 2026 Tasker Inc
               </p>
               <ul className="flex flex-col items-end justify-center text-main_lightly text-sm font-montserrat-medium">
                  ...
                  <li className="cursor-pointer transition-colors duration-100 ease-in-out hover:text-main_green_light hover:scale-105">Умови використання.</li>
                  <li className="cursor-pointer transition-colors duration-100 ease-in-out hover:text-main_green_light hover:scale-105">Cookies.</li>
               </ul>
            </div>
         </footer>
      </>
