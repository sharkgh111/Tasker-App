                     ...
                     <ul className="w-full flex items-center justify-center flex-col text-lg font-montserrat-medium text-main_lightly">
                        {array.map((item) => (
                           <li
                              ...
                              className={`py-1 px-3 hover:bg-main_green_dark/20 w-full ${item.id === activeSearchMode ? "bg-main_green_dark/30" : "bg-main_green_primary/60"} text-center cursor-pointer`}
                           >
                              {item.title}
                           </li>
                        ))}
