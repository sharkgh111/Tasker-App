     ...
     return (
          <label className="flex items-center flex-col justify-center gap-3 cursor-pointer select-none group font-montserrat-medium text-xl text-main_lightly">
               ...
               <div
                ...
                `}
               >
                    {checked && <div className="w-4 h-4 rounded-full bg-main_lightly" />}
               </div>
               ...
               {label && (
                    <span
                        ...
                        ${checked ? "opacity-100 max-h-10 mt-1 translate-y-0 text-main_lightly" : "opacity-0 max-h-0 mt-0 -translate-y-1 pointer-events-none text-transparent"}
                    `}
